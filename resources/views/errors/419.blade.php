    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="text-center">
            ...
            <p class="text-gray-600 mb-8 max-w-sm mx-auto">
                Your session has expired due to inactivity. This usually happens when the page has been idle for too long or the form token has expired.
            </p>
        </div>
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <ul class="list-disc list-inside space-y-1">
                                    <li>Your session token has expired for security reasons</li>
                                    <li>The page was open for too long without activity</li>
                                    <li>The form submission timed out</li>
                                </ul>
                            </div>
                        </div>
                    </div>
