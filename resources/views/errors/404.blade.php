    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="text-center">
            ...
            <p class="text-gray-600 mb-8 max-w-sm mx-auto">
                Sorry, we couldn't find the page you're looking for. The page may have been moved, deleted, or the URL was typed incorrectly.
            </p>
        </div>
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-3">
                    @auth
                        ...
                        @can('deposit_funds')
                        <a href="{{ route('wallet.deposit') }}" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                            <svg class="-ml-1 mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
